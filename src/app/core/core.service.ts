...
import { Privilege } from 'app/modules/presentation/admin/privilege/privilege.types';
import {
    Parametrages,
    Utilisateur,
} from 'app/modules/presentation/admin/recherche/recherche.types';
...
export class CoreService {
    ...
    private _utilisateurs: any;
    private _privileges: any;
            ...
            if (data.isGlobal) {
                ...
                return this._httpClient
                    ...
                    .pipe(
                        map((response) => {
                            response['list'] =
                                response[this.constantes.RESPONSE_DATA];
                            return response;
                        })
                    );
            } else {
    ...
    addFileExtourne(data) {
        return this._httpClient
            .post(
                environment.apiURL + 'extourner-transactions-par-fichier',
                data
            )
            .pipe(
    ...
    rapportBic(dateFormatee, url) {
        return this._httpClient
            .get(environment.apiURL + url + dateFormatee, {
                responseType: 'blob',
            })
            .pipe((response) => response);
    }
    ...
    listJobInstances(jobName) {
        return this._httpClient
            .get(
                environment.batchApiURL +
                    'batches/operations/list?jobName=' +
                    jobName
            )
            .pipe((response) => response);
    }
    ...
    start(jobName) {
        return this._httpClient
            .get(
                environment.batchApiURL +
                    'batches/operations/start?jobName=' +
                    jobName
            )
            .pipe((response) => response);
    }
    ...
    restart(jobName) {
        return this._httpClient
            .get(
                environment.batchApiURL +
                    'batches/operations/restart?executionId=' +
                    jobName
            )
            .pipe((response) => response);
    }
    ...
    stopper(jobName) {
        return this._httpClient
            .get(
                environment.batchApiURL +
                    'batches/operations/stop?executionId=' +
                    jobName
            )
            .pipe((response) => response);
    }
    ...
    rejetVirementPerm(id, data) {
        return this._httpClient
            .post(
                environment.apiURL + 'virements-permanents/rejeter/' + id,
                data
            )
            .pipe((response) => response);
    }
    ...
    block(el) {
        return this._httpClient
            .put(
                environment.batchApiURL + 'sequence/update-statut/' + el?.id,
                el
            )
            .pipe(
                switchMap((response: any) =>

...
import { Chat } from 'app/modules/presentation/admin/apps/chat/chat.types';
import { ContactInfoComponent } from 'app/modules/presentation/admin/apps/chat/contact-info/contact-info.component';

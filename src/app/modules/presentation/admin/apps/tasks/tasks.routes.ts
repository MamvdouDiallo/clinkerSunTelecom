...
import { TasksDetailsComponent } from 'app/modules/presentation/admin/apps/tasks/details/details.component';
import { TasksListComponent } from 'app/modules/presentation/admin/apps/tasks/list/list.component';
import { TasksComponent } from 'app/modules/presentation/admin/apps/tasks/tasks.component';
import { TasksService } from 'app/modules/presentation/admin/apps/tasks/tasks.service';

...
import { ScrumboardBoardComponent } from 'app/modules/presentation/admin/apps/scrumboard/board/board.component';
import { ScrumboardBoardsComponent } from 'app/modules/presentation/admin/apps/scrumboard/boards/boards.component';
import { ScrumboardCardComponent } from 'app/modules/presentation/admin/apps/scrumboard/card/card.component';
import { Board } from 'app/modules/presentation/admin/apps/scrumboard/scrumboard.models';
import { ScrumboardService } from 'app/modules/presentation/admin/apps/scrumboard/scrumboard.service';

...
import { MailboxDetailsComponent } from 'app/modules/presentation/admin/apps/mailbox/details/details.component';
import { MailboxEmptyDetailsComponent } from 'app/modules/presentation/admin/apps/mailbox/empty-details/empty-details.component';
import { MailboxListComponent } from 'app/modules/presentation/admin/apps/mailbox/list/list.component';
import { MailboxComponent } from 'app/modules/presentation/admin/apps/mailbox/mailbox.component';
import { MailboxService } from 'app/modules/presentation/admin/apps/mailbox/mailbox.service';
import { MailboxSettingsComponent } from 'app/modules/presentation/admin/apps/mailbox/settings/settings.component';

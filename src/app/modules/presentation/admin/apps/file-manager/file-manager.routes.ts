...
import { FileManagerDetailsComponent } from 'app/modules/presentation/admin/apps/file-manager/details/details.component';
import { FileManagerComponent } from 'app/modules/presentation/admin/apps/file-manager/file-manager.component';
import { FileManagerService } from 'app/modules/presentation/admin/apps/file-manager/file-manager.service';
import { FileManagerListComponent } from 'app/modules/presentation/admin/apps/file-manager/list/list.component';

...
import { ContactsComponent } from 'app/modules/presentation/admin/apps/contacts/contacts.component';
import { ContactsService } from 'app/modules/presentation/admin/apps/contacts/contacts.service';
import { ContactsDetailsComponent } from 'app/modules/presentation/admin/apps/contacts/details/details.component';
import { ContactsListComponent } from 'app/modules/presentation/admin/apps/contacts/list/list.component';

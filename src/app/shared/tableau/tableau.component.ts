...
export class TableauComponent implements OnInit {
    ...
    displayedColumnsFile: string[] = ['Matricule', 'Intitule', 'Ville', 'TypeClient', 'Email', 'Statut', 'Date de création'];
    tabFileBody: string[] = ['matricule', 'intitule', 'ville', 'typeClient', 'email', 'statut', 'createdAt',];
    ...
    getBadgeClass(element, entete) {
        if (entete.badgeClass) {
            const found = entete.badgeClass.find(el => el.name == '' + element[entete.td]);
